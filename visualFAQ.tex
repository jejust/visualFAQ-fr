...
\faq{3_composition/texte/titres/modifier_le_style_des_titres}{"Comment modifier le style des titres de sectionnement?"}{%
  ...
  Scott Pakin\hspace{\fill}Adaptation fran\c{c}aise: J\'er\'emy Just\par
...
\begin{equation}
  \faq{4_domaines_specialises/mathematiques/symboles_de_separateurs}{"Set specifications and Dirac brackets"}{%
...
%   FAQfr: "Creating a bibliography style" (3_composition/annexes/bibliographie/creer_un_style_de_bibliographie)
\bibitem{custbib}
...
%   FAQfr: "URLs in BibTeX bibliographies" (Comment citer une URL avec BibTeX?)
\bibitem{normal}
